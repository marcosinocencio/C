...
typedef struct RegAdjNode AdjNode; // Estrutura que conecta os nós em uma mesma posição da lista
...
typedef struct{
	...
	AdjNode *adj; // Nó adjacente na lista
} Digraph;

// Estrutura de grafo -------------------------------------------------------------------------------
typedef struct{
	int qntg; // Quantidade de nós armazenados no grafo
