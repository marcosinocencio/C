...
int gera_valor( int valor){
   int i;
   while(valor>MAX){
                    if(valor>=1000000){i=valor/1000000;
                                       valor = valor - i * 1000000;
                                       valor=valor+i;}
                    if(valor>=100000){i=valor/100000;
                                       valor = valor - i * 100000;
                                       valor=valor+i;}
                    if(valor>=10000){i=valor/10000;
                                       valor = valor - i * 10000;
                                       valor=valor+i;}
                    if(valor>=1000){i=valor/1000;
                                       valor = valor - i * 1000;
                                       valor=valor+i;}
                    if(valor>=100){i=valor/100;
                                       valor = valor - i * 100;
                                       valor=valor+i;}
                    if(valor>=10){i=valor/10;
                                       valor = valor - i * 10;
                                       valor=valor+i;}
                    }
 return(valor);}
